    ...
    def check_link(link_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            if href.startswith(("http://", "https://")):
                ...
                # Local / relative
                if href.startswith("#"):
                    # Intra-page fragment reference is considered valid
                    result["status"] = 200
                ...
                result["is_broken"] = True
                result["error"] = "Local/relative path cannot be verified without a base directory"
...
def html_link_validation_in_collection_by_id(collection_id: int, auth_token: str):
    ...
    for item in tqdm(html_items):
        content = get_file_content(file_id=item.get("id"), auth_token=auth_token)
        file_results = link_checker_single_html(html_content=content, source_file=item.get("file_name"))
...
"""
{
  ...
  "build_html_document_index": {
    "collection_id": 1152,
    "auth_token": "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..gk5l1bwxBMl61Rjti67bXwKpr7IUv6EFyAr6YuJx8RxQ1uzCJy4ZefKNySVAF18HzOJcAKLovZsRm8_QYx7xoP3MNlYYy7kF5-bqoduLVTPVTbi2xoYs3WvuTsDIKTPixXXc-xXzOEDCHfzRVdELe9c8Lxnj7GdP-AXtJneJjPKqsYc8MFMPVvD9lblb7H4-ryfcIPC5RiSrEUah3T-euutzetwFWhBbgxM8tTZAk-_5_UcsDy5D-Kc0fQbkzM711EX47V_4npZz1dnXJWPkcipxV8DGCKQ86qVrvpyYGLDae0wCHkAaofQbUB1iZv5FpuOtmqnmqPYsxoBUGHqOew"
  },
  "link_checker_single_html": {
  ...
  "html_link_validation_in_collection_by_id": {
    "collection_id": 1152,
    "auth_token": "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..gk5l1bwxBMl61Rjti67bXwKpr7IUv6EFyAr6YuJx8RxQ1uzCJy4ZefKNySVAF18HzOJcAKLovZsRm8_QYx7xoP3MNlYYy7kF5-bqoduLVTPVTbi2xoYs3WvuTsDIKTPixXXc-xXzOEDCHfzRVdELe9c8Lxnj7GdP-AXtJneJjPKqsYc8MFMPVvD9lblb7H4-ryfcIPC5RiSrEUah3T-euutzetwFWhBbgxM8tTZAk-_5_UcsDy5D-Kc0fQbkzM711EX47V_4npZz1dnXJWPkcipxV8DGCKQ86qVrvpyYGLDae0wCHkAaofQbUB1iZv5FpuOtmqnmqPYsxoBUGHqOew"
  }
}
